    ...
    <Layout videoSrc={homeVideo}>
      <div className="flex flex-col items-center justify-center space-y-8">
        <div className="max-w-2xl text-center space-y-6">
          <h1 className="text-2xl md:text-3xl font-light leading-relaxed tracking-wider text-shadow-strong">
            Opening eyes to the fabric of words & images
          </h1>
          <p className="text-lg font-light leading-relaxed opacity-90 text-shadow">
