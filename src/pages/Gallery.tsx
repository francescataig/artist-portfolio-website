      ...
      >
        {currentImageIndex !== null ? (
          <div className="max-w-4xl mx-auto transition-all duration-500 ease-in-out">
            ...
            />
            <p className="text-white text-sm font-light mt-2 opacity-70 text-center text-shadow">
              Artwork {currentImageIndex + 1} of {images.length} - Click for next
            </p>
          </div>
        ) : (
          <p className="text-white text-xl font-light opacity-70 animate-pulse text-shadow">
